...
class rwGoogle {
    ...
    async googleJSON(args) {
        ...
        this.data.data = this.csvJSON(csv_data);
    ...
    writeGoogleSheetCol(args) {
        ...
        if (this.googleSheetURL != "") {
            ...
            else return `請填寫此積木的欄位名稱或資料值`;
        } else return `請使用讀取 Google 試算表部屬的網址積木或網址有誤`;
    }
    ...
    writeGoogleFormCol(args) {
        ...
        } else return `請使用讀取 Google 表單的 ID 積木`;
    }
    ...
    sendGoogleForm(args) {
        ...
        if (this.googleFormID != "") {
            if (this.googleFormData != "") {
                fetch(url, { mode: "no-cors", credentials: "include" });
                this.googleFormData = "";
            } else return `請使用寫入表單欄位 ID 的值積木`;
        } else return `請使用讀取 Google 表單的 ID 積木或表單 ID 有誤`;
    }
